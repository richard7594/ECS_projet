...
| [aws_ecs_capacity_provider.cluster_ecs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ecs_capacity_provider) | resource |
| [aws_ecs_cluster.cluster_ecs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ecs_cluster) | resource |
...
| [aws_iam_instance_profile.name](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_instance_profile) | resource |
| [aws_iam_role.ec2_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role.ecs_task_execution_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role.infra_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role_policy_attachment.ecs_permission](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.ecs_permission1](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_iam_role_policy_attachment.name1](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_lb_listener.list](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener) | resource |
...
| [aws_iam_policy_document.infra_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_az"></a> [az](#input\_az) | n/a | `list(string)` | <pre>[<br/>  "eu-west-1a",<br/>  "eu-west-1b"<br/>]</pre> | no |
| <a name="input_cidr"></a> [cidr](#input\_cidr) | n/a | `string` | `"10.0.0.0/16"` | no |
| <a name="input_cidr_private"></a> [cidr\_private](#input\_cidr\_private) | n/a | `map(string)` | <pre>{<br/>  "eu-west-1a": "10.0.3.0/24",<br/>  "eu-west-1b": "10.0.4.0/24"<br/>}</pre> | no |
| <a name="input_cidr_public"></a> [cidr\_public](#input\_cidr\_public) | n/a | `map(string)` | <pre>{<br/>  "eu-west-1a": "10.0.1.0/24",<br/>  "eu-west-1b": "10.0.2.0/24"<br/>}</pre> | no |
